 ...
 * [MigrationGenerator](/reference/migration-generator).
 */
 ...
 * as generated by the [MigrationGenerator](/reference/migration-generator).
 */
...
/**
 * Interface that defines a migration for [runMigrations](/reference/run-migrations) to run.
 */
